...
@section('content')
   <div class="card">
       <div class="">
           <form action="" class="form-group d-flex justify-content-between align-items-center m-3">
...
<tr>
    <th>
               <select name="group" class="form-select" id="select0">
    ...
    <th>
               ...
               <select name="domla" class="form-select" id="select2">
                     <option value="0">Barchasi</option>
    ...
    <th>
               ...
               <select name="theme" class="form-select" id="select3">
                     <option value="0">Barchasi</option>
    ...
    <th><button type="submit" class="btn btn-primary "><i class="bx bx-filter-alt"></i>Filtr</button> </th>
</tr>
               </table>
           </form></div>
                    ...
                    @foreach($themes as $key=>$theme)
                     ...
                     <div  class="modal fade" id="batafsilModal{{$theme->id}}" tabindex="-1"
                                     ...
                                     @if( isset($theme->process->id))
                                        ...
                                        <div class="mb-3" >
                                            ...
                                            @if($theme->process->link==null or $theme->process->link=="Hozircha kiritilmagan" )
                                                <p>Hozircha kiritilmagan</p>
                                            @else
                                                <a href="{{$theme->process->link}}" class="btn btn-primary btn-sm m-2"> Ko'rish </a>
                                            @endif
                                        </div>
                                         <div class="mb-3" >
                                             ...
                                             @if($theme->process->file==null or $theme->process->file=="Hozircha kiritilmagan" )
                                                 <p>Hozircha kiritilmagan</p>
                                             @else
                                                 <a href="{{asset($theme->process->file)}}" class="btn btn-primary btn-sm m-2"><i class="bx bx-download"></i> Yuklab olish</a>
                                             @endif
                                            </div>
                                     @endif
                        ...
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td> <button data-bs-toggle="modal" data-bs-target="#batafsilModal{{$theme->id}}" type="button"
                            ...
                            <td>{{$theme->student_name}}
                                @if($theme->student_name == null) Tanlamagan @endif
                            </td>
